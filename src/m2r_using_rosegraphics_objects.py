...
#        necessary?  Why?
#            It makes sure the window stays open until the user is ready for it to close. Otherwise, it would close at the of completing its code
#
