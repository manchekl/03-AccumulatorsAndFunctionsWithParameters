...
def two_circles():
    ...
    circle1=rg.Circle(point1,10)
    circle1.attach_to(window)

    point2=rg.Point(300,200)
    circle2=rg.Circle(point2,30)
...
def circle_and_rectangle():
    ...
    rec=rg.Rectangle(rg.Point(50,50),rg.Point(200,150))
    circle=rg.Circle(Point,15)
...
def lines():
    ...
    line1=rg.Line(rg.Point(50,100),rg.Point(50,200))
    line2=rg.Line(rg.Point(200,150),rg.Point(250,150))
